...
<body class="bg-gray-100 font-poppins">
    <div class="w-full flex justify-center items-center min-h-screen">
        <div class="sign-up-container w-110 bg-white shadow-md flex flex-col justify-center py-2 px-6 rounded-xl" id="signUp">
                ...
                <form action="" method="post">
                    ...
                    <div
                        ...
                        <div class="input w-full">
                            <input type="password" id="inputSignUpPassword" class="focus:outline-none w-full" name="password"
                    ...
                    <div
                        ...
                        <div class="input w-full">
                            <input type="password" id="inputConfirmationPassword" class="focus:outline-none w-full" name="password"
